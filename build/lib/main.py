...
# ==========================================
# About Section - Updated with Beautiful Layout
# ==========================================

def show_about():
    """Show beautiful about information with ASCII art"""
    clear_screen()
...
{Colors.WHITE}{Colors.BOLD}☀️ CodeSunGrab{Colors.RESET}
...
{Colors.GOLD}✨ Features{Colors.RESET}
  ...
  {Colors.GREEN}•{Colors.RESET} Open-source developer tool
...
{Colors.GOLD}📱 Supported Platforms{Colors.RESET}
  {Colors.CYAN}•{Colors.RESET} YouTube
  {Colors.CYAN}•{Colors.RESET} Facebook
  {Colors.CYAN}•{Colors.RESET} Instagram
  {Colors.CYAN}•{Colors.RESET} Twitter / X
  {Colors.CYAN}•{Colors.RESET} TikTok
  {Colors.CYAN}•{Colors.RESET} Reddit
  {Colors.CYAN}•{Colors.RESET} Twitch
  {Colors.CYAN}•{Colors.RESET} Vimeo
  {Colors.CYAN}•{Colors.RESET} SoundCloud
  {Colors.CYAN}•{Colors.RESET} Dailymotion
...
{Colors.WHITE}Development Focus:{Colors.RESET}
  {Colors.GREEN}•{Colors.RESET} Python development
  {Colors.GREEN}•{Colors.RESET} Web development
  {Colors.GREEN}•{Colors.RESET} Cybersecurity concepts
  {Colors.GREEN}•{Colors.RESET} AI tools and automation
  {Colors.GREEN}•{Colors.RESET} Prompt engineering
  {Colors.GREEN}•{Colors.RESET} Open-source projects
  {Colors.GREEN}•{Colors.RESET} Developer productivity tools
...
{Colors.GOLD}🌐 Social & Online Profiles{Colors.RESET}
  ...
  {Colors.CYAN}Portfolio:{Colors.RESET} https://codewithrafsun.com
...
and the legendary Lionel Messi. The sky blue and white colors 
of Argentina inspired the design of this tool.{Colors.RESET}
