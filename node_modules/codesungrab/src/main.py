...
def account_settings():
    ...
    print(f"  {Colors.GOLD}[1]{Colors.RESET} Verify Email")  # ← NEW
...
def verify_email_flow():
    ...
    print(f"{Colors.YELLOW}Sending new verification code...{Colors.RESET}")
    type_loading("Sending code", 2)
...
def change_password():
    ...
    msg_info("This feature will be available in the next update")
    input("Press Enter...")
